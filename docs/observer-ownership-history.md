# Historical MQTT ownership plan

Archived on 2026-09-20. This is the earlier phase plan, not the current ownership contract. Its line references, deferred items and forced-delete description are historical. See [current contract](../MQTT_OWNERSHIP.md).
