...
private:
  ...
  // Close a live client because the route changed under it: bounded where that
  // is enough, a real stop where an in-flight attempt has to be cancelled.
  void closeLiveClientForLinkTransition(int index);
